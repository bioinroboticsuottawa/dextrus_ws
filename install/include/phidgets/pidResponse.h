// Generated by gencpp from file phidgets/pidResponse.msg
// DO NOT EDIT!


#ifndef PHIDGETS_MESSAGE_PIDRESPONSE_H
#define PHIDGETS_MESSAGE_PIDRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::phidgets::pidResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::phidgets::pidResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::phidgets::pidResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::phidgets::pidResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::phidgets::pidResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::phidgets::pidResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::phidgets::pidResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::phidgets::pidResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::phidgets::pidResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::phidgets::pidResponse_<ContainerAllocator>& v)
  {
    s << indent << "ack: ";
...
#endif // PHIDGETS_MESSAGE_PIDRESPONSE_H
