...
(cl:defmethod cl:initialize-instance :after ((m <ResetCalibration-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetCalibration-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name remap-srv:<ResetCalibration-request> is deprecated: use remap-srv:ResetCalibration-request instead.")))

(cl:ensure-generic-function 'resetRequest-val :lambda-list '(m))
(cl:defmethod resetRequest-val ((m <ResetCalibration-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader remap-srv:resetRequest-val is deprecated.  Use remap-srv:resetRequest instead.")
  (resetRequest m))
...
(cl:defmethod cl:initialize-instance :after ((m <ResetCalibration-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetCalibration-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name remap-srv:<ResetCalibration-response> is deprecated: use remap-srv:ResetCalibration-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResetCalibration-response>)))
  ...
  "remap/ResetCalibrationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResetCalibration-response)))
  "Returns string type for a service object of type 'ResetCalibration-response"
  "remap/ResetCalibrationResponse")
